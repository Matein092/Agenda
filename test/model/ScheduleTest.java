...
class ScheduleTest {
	...
	public void checkModifyContact() {
        ...
        //Modificar contacto
		schedule.modifyContact(name, lastName, telephone, email, id, semester, avatar, bornDate, age, program);
        ...
        //Modificar contacto
		schedule.modifyContact(name2, lastName2, telephone2, email2, id2, semester2, avatar2, bornDate2, age2, program2);
		// Se verifican si los datos se cambiaron correctamente
        ...
        //Modificar contacto
		schedule.modifyContact(name3, lastName3, telephone3, email3, id3, semester3, avatar3, bornDate3, age3, program3);
		// Se verifican si los datos se cambiaron correctamente
